...
static uint8_t app_lcd_bg_buffer[LCD_BG_WIDTH * LCD_BG_HEIGHT * 2] __attribute__((aligned(32))) __attribute__((section(".EXTRAM")));
...
void app_lcd_init(void)
{
    ...
    bsp_lcd_layer_config.address = (uint32_t)app_lcd_bg_buffer;
    ...
    bsp_lcd_layer_config.address = (uint32_t)app_lcd_fg_buffer[0];
